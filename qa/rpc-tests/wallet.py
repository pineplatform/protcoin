...
#   c) node1 mines 32 blocks, so now node 0 has 500000PROT, node 1 has 4250PROT, node2 has none.
#   d) node0 sends 601 PROT to node2, in two transactions (301 PROT, then 300 PROT).
