...
Intro
-----
Protcoin (PROT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Protcoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run protcoin-qt.exe.

Protcoin Core is the original Protcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Protcoin transactions;
