...
Protcoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<protcoin_address\> \<monthly_payment_protcoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _5000_ PROT, _12_ times over the course of a year totaling _60000_ PROT.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<protcoin_address\> \<monthly_payment_protcoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `5000` PROT.
