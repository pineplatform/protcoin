...
In order to support loading of multiple wallets in protcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is protcoin.cpp.
...
Changes to protcoin.cpp
----------------------
protcoin.cpp is the entry point into protcoin-qt, and as such, will require some minor modifications to provide hooks for
