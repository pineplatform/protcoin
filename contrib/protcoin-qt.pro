...
RESOURCES += src/qt/protcoin.qrc src/qt/protcoin_locale.qrc

TRANSLATIONS += src/qt/locale/protcoin_bg.ts \
                src/qt/locale/protcoin_de.ts \
                src/qt/locale/protcoin_en.ts \
                src/qt/locale/protcoin_es.ts \
                src/qt/locale/protcoin_fi.ts \
                src/qt/locale/protcoin_fr.ts \
                src/qt/locale/protcoin_it.ts \
                src/qt/locale/protcoin_ja.ts \
                src/qt/locale/protcoin_pl.ts \
                src/qt/locale/protcoin_pt.ts \
                src/qt/locale/protcoin_ru.ts \
                src/qt/locale/protcoin_sk.ts \
                src/qt/locale/protcoin_sv.ts \
                src/qt/locale/protcoin_vi.ts \
                src/qt/locale/protcoin_zh_CN.ts \
                src/qt/locale/protcoin_zh_TW.ts
