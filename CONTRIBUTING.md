Contributing to Protcoin Core
==================================

The Protcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Protcoin Core project, and is not to be
confused with overall Protcoin Network Protocol consensus changes.

Whether a pull request is merged into Protcoin Core rests with the project merge
...
Patches that change Protcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Protcoin consensus, it must have been
...
The project leader is the release manager for each Protcoin Core release.
