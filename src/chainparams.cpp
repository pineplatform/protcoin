...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000005ae7c4c33463b820eba1a6754cb0491b3dfe6fec767d7dbd3465d08b21b"))
    (2055, uint256("0x0574045a5d7974199b90154b4f2a9e05ee8b2823dd056e820891091e2066b2e3"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1564282594, // * UNIX timestamp of last checkpoint block
    2616,     // * total number of transactions between genesis and last checkpoint (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CMainParams()
    {
        ...
        nDefaultPort                   = 30111;
        nSubsidyHalvingInterval        = 6050000;
        ...
        genesis.nVersion               = 1;
        genesis.nTime                  = 1564167453;
        genesis.nBits                  = 0x1e0ffff0;
        genesis.nNonce                 = 21415322;
        ...
        assert(hashGenesisBlock        == uint256("0x000005ae7c4c33463b820eba1a6754cb0491b3dfe6fec767d7dbd3465d08b21b"));
        ...
        strMasternodePoolDummyAddress  = "PXBnT7RUssHSGZiuhbZpkD8zNRwxRMf825";
        nStartMasternodePayments       = genesis.nTime + 60 * 60; // 1 hr after genesis

        nBudget_Fee_Confirmations      = 6; // Number of confirmations for the finalization fee

        strTreasuryAddress             = "PJLUFRTe3Lsy2A2UKZXyrfGzHd9eg9NdHX";
    }
