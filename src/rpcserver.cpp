...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Protcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Protcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Protcoin features */
        {"protcoin", "masternode", &masternode, true, true, false},
        {"protcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"protcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"protcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"protcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"protcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"protcoin", "startmasternode", &startmasternode, true, true, false},
        {"protcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"protcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"protcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"protcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"protcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"protcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"protcoin", "mnbudget", &mnbudget, true, true, false},
        {"protcoin", "preparebudget", &preparebudget, true, true, false},
        {"protcoin", "submitbudget", &submitbudget, true, true, false},
        {"protcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"protcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"protcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"protcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"protcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"protcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"protcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"protcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"protcoin", "mnsync", &mnsync, true, true, false},
        {"protcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> protcoin-cli " + methodname + " " + args + "\n";
}
