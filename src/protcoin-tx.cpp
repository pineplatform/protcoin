...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Protcoin Core protcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  protcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded protcoin transaction") + "\n" +
                               "  protcoin-tx [options] -create [commands]   " + _("Create hex-encoded protcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded protcoin transaction
