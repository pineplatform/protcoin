...
// Repair parameters
const QString PROTCOINWALLET("-protcoinwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_protcoinwallet, SIGNAL(clicked()), this, SLOT(walletProtcoin()));
...
/** Restart wallet with "-protcoinwallet" */
void RPCConsole::walletProtcoin()
{
    buildParameterlist(PROTCOINWALLET);
}
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Protcoin RPC console.") + "<br>" +
