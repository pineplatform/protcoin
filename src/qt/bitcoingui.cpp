                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Protcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PROT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and protcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Protcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Protcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Protcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PROT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PROT addresses"));
    ...
    openAction->setStatusTip(tr("Open a protcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Protcoin Core help message to get a list with possible Protcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Protcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Protcoin network", "", count));
}
...
{
    QString strTitle = tr("Protcoin Core"); // default title
