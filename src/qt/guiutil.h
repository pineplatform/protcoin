...
/** Utility functions used by the Protcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render PROT addresses in monospace font
...
// Parse "protcoin:" URI into recipient object, return true on successful parsing
