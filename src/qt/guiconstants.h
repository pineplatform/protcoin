...
/* Protcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Protcoin"
#define QAPP_ORG_DOMAIN "protexchange.com"
#define QAPP_APP_NAME_DEFAULT "Protcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Protcoin-Qt-testnet"
