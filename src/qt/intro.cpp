...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Protcoin Core"),
     ...
     * override -datadir in the protcoin.conf file in the default data directory
     * (to be consistent with protcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
